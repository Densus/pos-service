...
type UserRepository interface {
	...
	AllUser() []entity.User
	DeleteUser(UserID string, user entity.User)
...
//GetUser is a method to get user profile by UserID
func (d *dbUserConnection) GetUser(UserID string) entity.User {
...
func (d *dbUserConnection) DeleteUser(UserID string, user entity.User) {
	d.dbConnection.Where("id = ?", UserID).Delete(&user)
}
